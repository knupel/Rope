...
bool_vec.z(true);
println("bool_vec.only():",bool_vec.only(), "data",bool_vec);
println("bool_vec.only(0,1,2):",bool_vec.only(0,1,2), ">>>>>>>>>>>>> data",bool_vec);
println("bool_vec.only(0,1):",bool_vec.only(0,1), ">>>>>>>>>>>>> data",bool_vec);
println("bool_vec.only(0,1,3):",bool_vec.only(0,1,3), ">>>>>>>>>>>>> data",bool_vec); 
println("bool_vec.only(4,5,6,1,3):",bool_vec.only(4,5,6,1,3), ">>>>>>>>>>>>> data",bool_vec);
println("bool_vec.only(-1):",bool_vec.only(-1), ">>>>>>>>>>>>> data",bool_vec); 
println("!bool_vec.only():",!bool_vec.only(), ">>>>>>>>>>>>> data",bool_vec);
